...
namespace TKKN_NPS
{
	...
	public class DustDevil : ThingWithComps
	{
		...
		private static readonly Material DustDevilMaterial = MaterialPool.MatFrom("Things/Ethereal/Tornado", ShaderDatabase.Transparent, MapMaterialRenderQueues.Tornado);

		private static readonly FloatRange PartsDistanceFromCenter = new FloatRange(1f, 5f);

		private static readonly float ZOffsetBias = -4f * DustDevil.PartsDistanceFromCenter.min;
